...
class EnhancedSkillLoader:
    ...
    1. Project skills: ./.titan/skills/
    2. User skills: ~/.titan/skills/
    3. Builtin skills: titan/titan/skills/builtin/
    """
    ...
    def __init__(
        ...
        self.user_skills_dir = Path.home() / ".titan" / "skills"

        # Determine project skills directory
        if self.project_dir:
            self.project_skills_dir = self.project_dir / ".titan" / "skills"
        else:
