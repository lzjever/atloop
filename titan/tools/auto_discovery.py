...
class ToolDiscovery:
    ...
    def __init__(self, tools_dir: Optional[Path] = None):
        ...
        Args:
            tools_dir: Directory containing tool modules (default: titan/tools)
        """
    ...
    def _file_to_module_path(self, file_path: Path) -> str:
        ...
        Returns:
            Module path (e.g., "titan.tools.filesystem.write_file")
        """
        ...
        try:
            ...
            # Fallback: use parts and find titan
            parts = list(abs_file_path.parts)
            if "titan" in parts:
                titan_idx = parts.index("titan")
                module_parts = parts[titan_idx:]
                # Remove .py extension
...
def auto_register_tools(
    ...
    Args:
        ...
        sandbox: Sandbox adapter instance
        skill_loader: Optional skill loader instance
        tools_dir: Optional tools directory (default: titan/tools)
