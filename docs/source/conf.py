...
try:
    from atloop import __version__
except ImportError as e:
    raise ImportError(
        f"Failed to import atloop.__version__: {e}. "
        "Make sure the package is installed or the project root is in sys.path."
    ) from e

project = 'atloop'
copyright = '2025, atloop Team'
author = 'atloop Team'
release = __version__  # Full version (e.g., '0.1.0')
...
html_theme_options = {
    ...
    "footer_icons": [
        {
            "name": "GitHub",
            "url": "https://github.com/lzjever/atloop",
            "html": """
