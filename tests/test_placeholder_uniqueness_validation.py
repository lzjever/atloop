...
class TestPlaceholderUniquenessValidation:
    ...
    def test_duplicate_across_different_tools(self):
        ...
        actions = [
            {"tool": "write_file", "args": {"path": "a.py", "content": "WRITE_FILE_CONTENT_file:test.py"}},
            {"tool": "edit_file", "args": {"path": "b.py", "content": "WRITE_FILE_CONTENT_file:test.py"}},  # Same name, different tool
        ]
    ...
    def test_multiple_duplicates_detected(self):
        ...
        actions = [
            {"tool": "write_file", "args": {"path": "a.py", "content": "WRITE_FILE_CONTENT_file:test.py"}},
            {"tool": "write_file", "args": {"path": "b.py", "content": "WRITE_FILE_CONTENT_file:test.py"}},  # Duplicate 1
            {"tool": "write_file", "args": {"path": "c.py", "content": "WRITE_FILE_CONTENT_file:test.py"}},  # Duplicate 2
        ]
    ...
    def test_duplicate_with_special_characters(self):
        ...
        actions = [
            {"tool": "write_file", "args": {"path": "a.py", "content": "WRITE_FILE_CONTENT_file: test.py (backup)"}},
            {"tool": "write_file", "args": {"path": "b.py", "content": "WRITE_FILE_CONTENT_file: test.py (backup)"}},  # Duplicate
        ]
        ...
        placeholder_names = [info.placeholder for info in placeholder_info if info.placeholder]
        assert len(placeholder_names) == 2
        assert placeholder_names[0] == placeholder_names[1]  # Duplicate detected even with special chars
...
class TestPlaceholderUniquenessInPlanPhase:
    ...
    def test_validate_uniqueness_logic(self):
        ...
        assert duplicate_action_index == 2, f"Duplicate should be in action 2, got {duplicate_action_index}"
