...
class TestRuleBasedCompressionPolicy:
    ...
    def test_rule_based_compression_tool_results(self):
        ...
        original_count = len(state.memory.tool_results_history)
        ...
        compressed_records = [r for r in compressed_memory.tool_results_history if isinstance(r, dict) and r.get("type") == "compressed"]
